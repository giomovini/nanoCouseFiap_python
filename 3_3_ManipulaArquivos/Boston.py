with open("3_3_ManipulaArquivos/economic-indicators.csv", "r") as boston:
    total_voos = 0
    maior = 0
    total_passageiros = 0
    ...
    print("Mês/Ano de maior movimento no aeroporto foi: ", str(mes),"/",str(ano))
    print("O total de passageiros do ano ", ano_usuario, "foi de ", total_passageiros)
    print("O Mês do ano ", ano_usuario, "com maior média diaria foi de: ", maior_media_diaria)
